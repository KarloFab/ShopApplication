...
public class VendorControllerTest {
    ...
    public void getVendorById() throws Exception{
        given(vendorService.getById(anyLong())).willReturn(vendorDTO_1);
    ...
    public void updateVendor() throws Exception{
        given(vendorService.saveVendorByDTO(anyLong(), Mockito.any(VendorDTO.class))).willReturn(vendorDTO_1);
